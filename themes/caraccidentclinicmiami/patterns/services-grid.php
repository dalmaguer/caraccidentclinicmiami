...
<div class="wp-block-column overflow-hidden" style="flex-basis:42%"><!-- wp:cover {"url":"<?php echo esc_html($image_url) ?>","dimRatio":0,"minHeight":0,"minHeightUnit":"px","contentPosition":"center center","isDark":false,"className":"!h-full min-h-96","style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"}}}} -->
