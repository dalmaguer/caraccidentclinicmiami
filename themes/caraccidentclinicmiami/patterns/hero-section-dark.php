<?php
/**
 * Title: Hero Section - Dark Theme
 * Slug: caraccidentclinicmiami/hero-section-dark
 * Categories: caraccidentclinicmiami, caraccidentclinicmiami/hero
 * Description: Full-width hero with dark overlay, light text, and CTA buttons.
 * Keywords: hero, banner, cover, cta, dark
 * Block Types: core/cover
 * Post Types: page
 */
$image_url = get_template_directory_uri() . '/assets/images/placeholder_landscape.png';
?>
<!-- wp:cover {"url":"<?php echo esc_url( $image_url ); ?>","dimRatio":30,"overlayColor":"primary-dark","minHeight":600,"minHeightUnit":"px","isDark":true,"align":"full","className":"hero-dark-theme","style":{"spacing":{"padding":{"top":"var:preset|spacing|90","bottom":"var:preset|spacing|90","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}}} -->
<div class="wp-block-cover alignfull is-dark hero-dark-theme" style="padding-top:var(--wp--preset--spacing--90);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--90);padding-left:var(--wp--preset--spacing--50);min-height:600px"><span aria-hidden="true" class="wp-block-cover__background has-primary-dark-background-color has-background-dim-30 has-background-dim"></span><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( $image_url ); ?>" data-object-fit="cover"/>
...
<!-- wp:heading {"level":1,"style":{"typography":{"fontWeight":"800","lineHeight":"1.1"}},"textColor":"white","fontSize":"huge"} -->
<h1 class="wp-block-heading has-white-color has-text-color has-huge-font-size" style="font-weight:800;line-height:1.1">Happiness Begins with Good Health</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"light-gray","fontSize":"medium"} -->
<p class="has-light-gray-color has-text-color has-medium-font-size">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
<!-- /wp:paragraph -->
