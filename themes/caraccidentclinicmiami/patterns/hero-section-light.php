...
?>
<!-- wp:cover {"url":"<?php echo esc_url( $img_url ); ?>","dimRatio":30,"overlayColor":"white","isUserOverlayColor":true,"focalPoint":{"x":0.86,"y":0.54},"minHeight":600,"minHeightUnit":"px","metadata":{"categories":["caraccidentclinicmiami/hero"],"patternName":"caraccidentclinicmiami/hero-section-light","name":"Hero Section - Light Theme"},"className":"hero-light-theme alignfull","style":{"spacing":{"padding":{"top":"var:preset|spacing|90","bottom":"var:preset|spacing|90","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover hero-light-theme alignfull" style="padding-top:var(--wp--preset--spacing--90);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--90);padding-left:var(--wp--preset--spacing--50);min-height:600px"><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( $img_url ); ?>" style="object-position:86% 54%" data-object-fit="cover" data-object-position="86% 54%"/><span aria-hidden="true" class="wp-block-cover__background has-white-background-color has-background-dim-30 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"type":"default"}} -->
